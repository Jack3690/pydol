...
class Base():
    """Base Class for Bayesian Star-Formation History using
        PyStan (Jairo Alzate (2023))"""

    def Normal_MGk(self, fw_dat,fw_err,Iso_sig):   
        """
            Parameters
            ----------
            fw_dat: float,
            ...
            Iso_sig: float,
                     Isochrone tolerence magnitude
        """
        sig2 = fw_err*fw_err + Iso_sig*Iso_sig
