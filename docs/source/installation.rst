...
For installing particular DOLPHOT modules, you can modify the MakeFile to uncomment 'export USENIRCAM=1', 'export USEACS=1' and 'export USEWFC3=1' lines.
...
If you prefer to use the vega zero points instead of the new vega_sirius zero points for JWST/NIRCam. You can go to dolphot2.0/nircam/data and rename the filters.dat dat as filters_vega_sirius. dat and rename filters_vega.dat to filters.dat
