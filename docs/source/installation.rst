...
To alter the default maximum number of images and number of stars supported by DOLPHOT you can use can modify the values for 'DMAXNIMG' variable and 'DMAXNSTARS' variable.
